            ...
            <div className="mb-16 md:px-0 px-5">
                <div className="content">
                    <div className="md:col-span-8">
                        <p className="badge">Best Espressos</p>
                        <h2>
                    ...
                    <div className="sub-content">
                        <p>
                            Every coffee we serve is a reflection of our 
                            obsession with detail — from the first seed to the final coffee. 
                ...
                <div className="top-grid">
                    ...
                    <div className="md:col-span-3">
                        <div className="noisy" />
                        <img src="/images/abt1.avif" alt="grid-img-1" />
                    </div>
                ...
                <div className="bottom-grid">
                    <div className="md:col-span-8">
                        <div className="noisy" />
                        <img src="/images/abt3.avif" alt="grid-img-3" />
                    </div>
